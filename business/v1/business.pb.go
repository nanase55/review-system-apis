...
const file_business_v1_business_proto_rawDesc = "" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID2\x86\x02\n" +
	"\bBusiness\x12z\n" +
	"\vReplyReview\x12#.api.business.v1.ReplyReviewRequest\x1a!.api.business.v1.ReplyReviewReply\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18business/v1/review/reply\x12~\n" +
	"\fAppealReview\x12$.api.business.v1.AppealReviewRequest\x1a\".api.business.v1.AppealReviewReply\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19business/v1/review/appealB0\n" +
